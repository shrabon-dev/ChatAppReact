...
export const Userlist = () => {
  ...
  return (
    ...
    <div className={`${modeStatus ? 'dark_mode laptop:mt-2 tablet:mt-8  laptop:mr-0 tablet:mr-5':'light_mode laptop:mr-0 tablet:mr-5 laptop:mt-2  tablet:mt-8'}`}>
...
{/* <UserListReuseable  profile='../images/group/grp2.webp' name='Md. Sojol Haque' message='Hi! are you free now?' />
          <UserListReuseable  profile='../images/group/grp3.webp' name='Md. Sojol Haque' message='Hi! are you free now?' />
          <UserListReuseable  profile='../images/group/grp2.webp' name='Md. Sojol Haque' message='Hi! are you free now?' />
          <UserListReuseable  profile='../images/group/grp3.webp' name='Md. Sojol Haque' message='Hi! are you free now?' />
          <UserListReuseable  profile='../images/group/grp1.webp' name='Md. Sojol Haque' message='Hi! are you free now?' /> */}
